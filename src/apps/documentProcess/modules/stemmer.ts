...
const pluralWhitelist = ['محاسبات', 'بنابراین', 'اطلاعات', 'ادبیات', 'سازمان', 'جایگزین',
    'دبیرستان', 'سرزمین', 'میانگین', 'کهکشان', 'زبان', 'عنوان', 'میدان', 'سلطان', 'ماشین',
    'امکان', 'زمان', 'مکان', 'تهران', 'مازندران', 'ایران'];
